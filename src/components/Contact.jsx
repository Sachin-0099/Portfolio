...
const Contact = () => {
  return (
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white pt-28'>
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form  className='flex flex-col justify-center w-full md:w-1/2' action="https://getform.io/f/bpjjonrb" method='post'>
                ...
                rows="10" className='p-2 bg-transparent border-2 rounded-md text-white focos:outline-none'></textarea>
